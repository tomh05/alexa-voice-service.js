...
const typedArrayToAudioBuffer = require('./utils/typedArrayToAudioBuffer.js');
...
resetContext() {
  ...
  startRecording() {
    ...
    fileToBuffer(arrayBuffer) {
        return typedArrayToAudioBuffer(arrayBuffer);
    }
    ...
    return new Promise((resolve, reject) => {
      ...
      xhr.open('POST', url, true);
        ...
        xhr.onload = (event) => {
            ...
            if (xhr.status == 204) {
                this._log('set language successfully');
                resolve(response);
                return;
            }
            ...
            if (errorDescription) {
                ...
                this._log(JSON.stringify(response));
            resolve(response);
        };
      ...
      const metadata = {
            "event": {
                "header": {
                    ...
                    "messageId": "7a8c1a24-d382-42e5-be8c-45acd04a74f1"
                },
                "payload": {
                    "settings": [
                        {
      ...
      const postDataStart = [
        ...
        NEWLINE, NEWLINE, JSON.stringify(metadata), NEWLINE].join('');

      const postDataEnd = [NEWLINE, BOUNDARY_DASHES, BOUNDARY, BOUNDARY_DASHES, NEWLINE].join('');

      const size = postDataStart.length + postDataEnd.length;
    ...
    sendAudio (dataView) {
      ...
      for (let j = 0; j < dataView.byteLength ; i++, j++) {
        uint8Array[i] = dataView.getUint8(j);
            ...
            console.log('writing bit', dataView.byteLength);
...
},{"./AmazonErrorCodes.js":3,"./Observable.js":4,"./Player.js":5,"./utils/arrayBufferToString.js":7,"./utils/downsampleBuffer.js":8,"./utils/interleave.js":9,"./utils/mergeBuffers.js":10,"./utils/typedArrayToAudioBuffer.js":11,"./utils/writeUTFBytes.js":12,"buffer":14,"http-message-parser":15,"qs":18,"uuid/v4":24}],3:[function(require,module,exports){
'use strict';
...
},{"./lib/bytesToUuid":22,"./lib/rng":23}]},{},[1]);
